...
<?php $__env->startSection('scripts'); ?>
  ...
  <script src="<?php echo e(asset('dsadmin/pages/scripts/product/create.js')); ?>"></script>
...
<?php $__env->startSection('styles'); ?>
  ...
  <link href="<?php echo e(asset("dsadmin/pages/css/product/create.css")); ?>" rel="stylesheet" type="text/css"/>
<?php $__env->stopSection(); ?>
  ...
  <div class="card card-primary">
    <div class="card-header ">
      ...
      <div class="float-sm-right">
        <a href="<?php echo e(route('product-index')); ?>">Listado</a> / <a class="active">Crear</a>
      </div>  
    </div>
    <div class="card-body">
      ...
      <div class="row">
          ...
          <div class="col-md-12">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" enctype="multipart/form-data" class="col-md-12" method="POST" action="<?php echo e(route('product-store')); ?>" id="form-general">
                <?php echo csrf_field(); ?>                
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="row form-group">
                      <div class="col col-md-6">
                        ...
                        <input type="text" name="product_name" class="form-control lowercase" id="product_name" placeholder="Nombre del producto" value="<?php echo e(old('product_name')); ?>" autocomplete="off" required>
                      </div>
                      <div class="col col-md-6">
                        <label for="exampleInputEmail1">Marca</label>
                        <input type="text" name="product_trademark" class="form-control lowercase" id="product_trademark" placeholder="Marca del producto" value="<?php echo e(old('product_trademark')); ?>" autocomplete="off" required>
                      </div>
                    </div>
                    <div class="row form-group" id="div-petition">
                      <div class="col col-md-6">
                        <label for="exampleInputEmail1">Contenido neto</label>
                        <input type="text" name="product_net_content" class="form-control lowercase" id="product_net_content" placeholder="Contenido neto del producto" value="<?php echo e(old('product_net_content')); ?>" autocomplete="off" required>
                      </div> 
                      <div class="col col-md-6">
                        <div class="form-group">
                          ...
                          <?php $__currentLoopData = $product_categorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($product_category->product_category_id); ?>"><?php echo e($product_category->product_category_name); ?></option>
                    ...
                    <div class="row form-group div-reply-modifiable" id="div-reply-modifiable-color">
                      <div class="col col-md-12">
                        ...
                        <input type="text" name="product_colors" class="form-control lowercase value_without_space input-reply-modifiable" id="color" placeholder="rojo,verde,azul,plateado" value="<?php echo e(old('color')); ?>" autocomplete="off" disabled>
                      </div>
                    </div>
                    <div class="row form-group div-reply-modifiable" id="div-reply-modifiable-flavor">
                      <div class="col col-md-12">
                        ...
                        <input type="text" name="product_flavors" class="form-control lowercase value_without_space input-reply-modifiable" id="flavor" placeholder="fresa,mango,mora,limon" value="<?php echo e(old('flavor')); ?>" autocomplete="off" disabled>
                      </div>
                    </div>
                    ...
                    <div class="row form-group">
                     <div class="col-md-9">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="number" name="product_price" class="form-control" id="product_price" placeholder="precio de producto" value="<?php echo e(old('product_price')); ?>" autocomplete="off" required>
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dsadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dulcesorpresa\resources\views/admin/product/create.blade.php ENDPATH**/ ?>